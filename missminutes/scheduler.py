...
class Scheduler:
    ...
    def schedule(self, start_date: datetime, days: int = 7) -> List[Session]:
        ...
        for task_id in sorted_task_ids:
            ...
            # Project time map for this task
            task_time_domain = task.project_time_domain(start_date, days)
            
            # Find available slots considering already scheduled sessions
            available_time_domain = self.apply_scheduled_constraints(task_time_domain)
            ...
            if suitable_slots:
                ...
                while remaining_duration > timedelta() and sorted_slots:
                    ...
                    available_domain = self.apply_scheduled_constraints(current_domain)
    ...
    def apply_scheduled_constraints(self, time_domain: TimeDomain) -> TimeDomain:
        """Apply constraints from already scheduled sessions"""
        ...
        # Subtract scheduled sessions from the available time
    ...
    def visualize_schedule(self, start_date: datetime, days: int = 7) -> Dict:
        ...
        Returns a dictionary mapping dates to lists of scheduled sessions
        """
        schedule_by_day = {}
